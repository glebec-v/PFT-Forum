    ...
    @if ($categories->count() > 0)
        <div class="col-lg-10 main">
            @foreach($categories as $category)
                <div class="row" style="border-radius: 10px 10px 0px 0px; padding: 0px 0px 5px 0px; border-style: dotted;
             border-color: #F7B10A; border-width: 1px">
                    ...
                    <div class="col-lg-1" style="padding-top: 2px" title="Новые темы в разделе">
                        <div class="list-group-item-heading">
                    ...
                    <div class="col-lg-1" style="padding-top: 2px" title="Новые сообщения в разделе">
                        <div class="list-group-item-heading">
                            <a href="#" class="list-group-item-text center-block">
